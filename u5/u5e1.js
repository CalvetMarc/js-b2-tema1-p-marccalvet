...
const converter = ( function(){
    ...
    function generate(text){
        ...
        const vocalsMap = {a: "1", á: "1", à: "1", e: "2", é: "2", è: "2", i: "3", í: "3", ï: "3", o: "4", ó: "4", ò: "4", u: "5", ú: "5", ü: "5" };
        
        return text.toLowerCase().replace(/[aàáeèéiíïoòóuúü]/g, (vocalFound) => vocalsMap[vocalFound]);
    }
